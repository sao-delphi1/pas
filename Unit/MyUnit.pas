...
var iCekHasp  : integer;
    ...
    sDGPb, sDGPj, sCustC, sSalesC, sDGK, sDGTr, sDGS, sDGR, sDGPR,sDRPb,sDRPj,sDGRPb,sDGRPj,sDGC,sDPB,sDGRBi,sDGRPLL,sCetak,sDRPc,sDRKas,sDRBank,FgOtoBagasi,MySalesID : string;
    sPPN : currency;
implementation
