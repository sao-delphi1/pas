...
Function InsertToAllItem(VoucherNo:string;TransDate:TDateTime;WareHouseId:string;ItemID:string;FgTrans:Byte;Qty:Currency;
                          Price:Currency;ModuleID:string;TempField2: string) : Integer;overload;
Function InsertToAllItem(VoucherNo:string;TempField:string;TransDate:TDateTime;WareHouseId:string;ItemID:string;FgTrans:Byte;Qty:Currency;
                         Price:Currency;CurrId:string;Rate:Currency;ModuleID:string;TempField2:string) : Integer;overload;
Function InsertToAllItem(VoucherNo:string;TempField:string;TransDate:TDateTime;WareHouseId:string;ItemID:string;FgTrans:Byte;Qty:Currency;
...
Function DeleteFromAllItem(VoucherNo:String;FgTrans:Byte):Integer;overload
Function DeleteFromAllItem(VoucherNo:String;ItemID:String;FgTrans:Byte):Integer;overload
...
Function DeleteFromAllItem(VoucherNo:String;TempField:string;ItemId:string;WarehouseId:String
                           ;Price : Currency;FgTrans:Byte):Integer;overload
...
Function InsertToAllItem(VoucherNo:string;TransDate:TDateTime;WareHouseId:string;ItemID:string;FgTrans:Byte;Qty:Currency;
                         Price:Currency;ModuleID:string;TempField2: string) : Integer;
begin
   with dmMain.quUnit,SQL do
   begin
      Close; Clear;
...
Function InsertToAllItem(VoucherNo:string;TempField:string;TransDate:TDateTime;WareHouseId:string;ItemID:string;FgTrans:Byte;Qty:Currency;
                         Price:Currency;CurrId:String;Rate:Currency;ModuleID:string;TempField2:string) : Integer;
begin
   with dmMain.quUnit,SQL do
   begin
      Close; Clear;
...
begin
   ...
   begin
      ...
      Add(' DELETE FROM AllItem WHERE VoucherNo=:VoucherNo AND TempField=:TempField '
         +' AND ItemID=:ItemID AND WarehouseId=:WareHouseId AND Price=:Price AND FgTrans=:FgTrans');
      with Parameters do
      begin
          ParamByName('VoucherNo').Value  := VoucherNo;
          ParamByName('TempField').Value  := TempField;
...
begin
   ...
   begin
      Close; Clear;
      Add('DELETE FROM AllItem WHERE VoucherNo=:VoucherNo AND FgTrans=:FgTrans');
      with Parameters do
      begin
          ParamByName('VoucherNo').Value  := VoucherNo;
          ParamByName('FgTrans').Value  := FgTrans;
...
begin
   ...
   begin
      Close; Clear;
      Add('DELETE FROM AllItem WHERE VoucherNo=:VoucherNo AND ItemID=:ItemId AND FgTrans=:FgTrans');
      with Parameters do
      begin
          ParamByName('VoucherNo').Value  := VoucherNo;
          ParamByName('ItemID').Value := ItemID;
