inherited fmSetSecurityAccess: TfmSetSecurityAccess
  ...
  object dxPageControl1: TdxPageControl [2]
    ...
    object ts02: TdxTabSheet
      ...
      object dbgUser: TdxDBGrid
        ...
        object dbgUserColumn5: TdxDBGridButtonColumn
          Caption = 'Nama'
          Width = 143
          BandIndex = 0
          RowIndex = 0
        ...
        object dbgUserColumn6: TdxDBGridColumn
          Caption = 'Margin Above (%)'
          Width = 94
          BandIndex = 0
          RowIndex = 0
          FieldName = 'OtoMargin'
  ...
  object quUser: TADOQuery
    ...
    object quUserSalesID: TStringField
      FieldName = 'SalesID'
    end
    object quUserFgGantiBagasi: TStringField
      FieldName = 'FgGantiBagasi'
      Size = 10
    end
    object quUserFgOtoSO: TStringField
      FieldName = 'FgOtoSO'
      Size = 10
    end
    object quUserOtoMargin: TBCDField
      FieldName = 'OtoMargin'
      DisplayFormat = '#,0'
      Precision = 18
    end
    object quUserLSalesName: TStringField
