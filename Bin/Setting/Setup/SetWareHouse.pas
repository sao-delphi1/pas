...
uses
  ...
  dxEdLib, dxDBELib,Printers, dxPageControl, ExtDlgs;
...
type
  TfmSettingGudang = class(TfmStdLv2)
    ...
    dxButton1: TdxButton;
    dxButton2: TdxButton;
    quMainDRPc: TStringField;
    quMainLDRPc: TStringField;
    quSetting: TADOQuery;
    ...
    buttonPPNKeluaran: TdxDBButtonEdit;
    GroupBox4: TGroupBox;
    Label17: TLabel;
    Label18: TLabel;
    DBText16: TDBText;
    ...
    quMainsPersediaan: TStringField;
    quMainsHPP: TStringField;
    quMainLPersediaan: TStringField;
    quMainLHPP: TStringField;
    ...
    Label12: TLabel;
    quMainFgLockDate: TDateTimeField;
...
uses UnitGeneral, Search, MyUnit;
...
begin
  ...
  if TRIM(quMainLRekPembelian.Value)='' then
  Begin
...
{  if TRIM(quMainDRPc.Value) = '' then
  begin
    MsgInfo('Kode Default Rekening Pendapatan Cash Back / Price Proteksi tidak boleh kosong');
    quMainDRPc.FocusControl;
    Abort;
  end;

  if TRIM(quMainLDRPc.Value) = '' then
  begin
    MsgInfo('Kode Default Rekening Pendapatan Cash Back / Price Proteksi tidak ada dalam Master');
    quMainDRPc.FocusControl;
    Abort;
  end;
...
begin
  ...
  SetBtnOperationVisible(dxButton7,dxButton8,FActDS);
end;
  ...
  inherited;
   with TfmSearch.Create(Self) do
      begin
       ...
       SQLString := ' SELECT Distinct GroupRekId as Kode_Group_Rekening,GroupRekName as Nama_Group_Rekening '
                   +'FROM CFMsGroupRek ORDER BY GroupRekId';
...
procedure TfmSettingGudang.dxButton1Click(Sender: TObject);
begin
  inherited;
  quMain.Post;
end;

procedure TfmSettingGudang.dxButton2Click(Sender: TObject);
begin
  inherited;
  Self.Close;
end;
...
procedure TfmSettingGudang.BitBtn1Click(Sender: TObject);
begin
  inherited;
...
procedure TfmSettingGudang.BitBtn2Click(Sender: TObject);
begin
  inherited;
