...
type
  TfmAPQRRptPembPerSupp = class(TfmRptLv4)
    QRLabel1: TQRLabel;
    QRDBText1: TQRDBText;
    QRDBText2: TQRDBText;
    QRDBText3: TQRDBText;
...
var
  fmAPQRRptPembPerSupp: TfmAPQRRptPembPerSupp;
...
procedure TfmAPQRRptPembPerSupp.QRDBText8Print(sender: TObject; var Value: String);
begin
  inherited;
  Value := FormatRptqtykurung(value);
end;

procedure TfmAPQRRptPembPerSupp.QRDBText5Print(sender: TObject;
  var Value: String);
begin
  inherited;
...
procedure TfmAPQRRptPembPerSupp.BndDetailBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
  inherited;
  PPN := 0;
...
procedure TfmAPQRRptPembPerSupp.bnd001AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  inherited;
...
procedure TfmAPQRRptPembPerSupp.QRLabel17Print(sender: TObject;
  var Value: String);
begin
  inherited;
...
procedure TfmAPQRRptPembPerSupp.QRLabel18Print(sender: TObject;
  var Value: String);
begin
  inherited;
...
procedure TfmAPQRRptPembPerSupp.MyReportBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
begin
  inherited;
  TPPN := 0;
...
procedure TfmAPQRRptPembPerSupp.QRLabel21Print(sender: TObject;
  var Value: String);
begin
  inherited;
...
procedure TfmAPQRRptPembPerSupp.QRLabel22Print(sender: TObject;
  var Value: String);
begin
  inherited;
...
procedure TfmAPQRRptPembPerSupp.QRLabel16Print(sender: TObject;
  var Value: String);
begin
  inherited;
...
procedure TfmAPQRRptPembPerSupp.QRLabel20Print(sender: TObject;
  var Value: String);
begin
  inherited;
