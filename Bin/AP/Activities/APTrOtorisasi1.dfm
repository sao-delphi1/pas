inherited fmAPTrOtorisasi: TfmAPTrOtorisasi
  ...
  inherited quMain: TADOQuery
    SQL.Strings = (
        ...
        '03) as Tgl,A.JatuhTempo as Term,CONVERT(VARCHAR(10),A.TransDate+' +
        'A.JatuhTempo,103) as JthTempo,A.TTLPb,'
      '       A.UpdUser,A.UpdDate,'
      
        '       (CASE WHEN A.FgOto='#39'Y'#39' THEN '#39'Approved'#39' ELSE '#39'Pending'#39' END' +
        ') as StatusOto '
      
        '       from APTrPurchaseHd A Inner Join APMsSupplier B on A.Supp' +
        'ID=B.SuppID')
