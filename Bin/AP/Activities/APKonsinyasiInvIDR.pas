...
begin
  ...
  begin
    if quAct.FieldByName('Price').AsCurrency <> quDetilPrice.AsInteger then
    begin
      with quAct1,SQL do
      begin
        Close;Clear;
        Add('UPDATE APTrKonsinyasiDt SET Price='''+quDetilPrice.AsString+''' '
           +'WHERE KonsinyasiID='''+quDetilKonsinyasiID.AsString+''' AND ItemID='''+quDetilItemID.AsString+''' ');
        Add('UPDATE APTrKonsinyasiHd SET Rate='''+quMainRate.AsString+''' '
           +'WHERE KonsinyasiID='''+quDetilKonsinyasiID.AsString+''' AND SuppID='''+quMainSuppID.AsString+''' ');
        Add('UPDATE AllItem SET Rate='''+quMainRate.AsString+''',Price='''+quDetilPrice.AsString+''' '
           +'WHERE VoucherNo='''+quDetilKonsinyasiID.AsString+''' AND ItemID='''+quDetilItemID.AsString+''' ');
        ExecSQL;
      end;
    end;
  end else
  begin
    ...
    begin
      ...
      begin
        Close;Clear;
        Add('UPDATE APTrKonsinyasiDt SET CurrID='''+quMainCurrID.AsString+''',Price='''+quDetilPrice.AsString+''' '
           +'WHERE KonsinyasiID='''+quDetilKonsinyasiID.AsString+''' AND ItemID='''+quDetilItemID.AsString+''' ');
        Add('UPDATE APTrKonsinyasiHd SET Rate='''+quMainRate.AsString+''' '
           +'WHERE KonsinyasiID='''+quDetilKonsinyasiID.AsString+''' AND SuppID='''+quMainSuppID.AsString+''' ');
        Add('UPDATE AllItem SET Rate='''+quMainRate.AsString+''',Price='''+quDetilPrice.AsString+''',CurrID='''+quMainCurrID.AsString+''' '
           +'WHERE VoucherNo='''+quDetilKonsinyasiID.AsString+''' AND ItemID='''+quDetilItemID.AsString+''' ');
        ExecSQL;
      end;
    end else
    begin
      ...
      begin
        Close;Clear;
        Add('UPDATE APTrKonsinyasiDt SET CurrID='''+quMainCurrID.AsString+''' '
           +'WHERE KonsinyasiID='''+quDetilKonsinyasiID.AsString+''' AND ItemID='''+quDetilItemID.AsString+''' ');
