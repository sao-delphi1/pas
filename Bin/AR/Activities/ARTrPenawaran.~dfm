inherited fmARTrPenawaran: TfmARTrPenawaran
    ...
    inherited pcParent: TdxPageControl
      ...
      inherited ts01: TdxTabSheet
        ...
        object dbgPenawaran: TdxDBGrid
          ...
          SummarySeparator = ', '
          TabOrder = 3
          OnDblClick = dbgPenawaranDblClick
          ...
          object dbgPenawaranItemID: TdxDBGridButtonColumn
            Caption = 'Kode Barang'
            Width = 103
            BandIndex = 0
            RowIndex = 0
            ...
            OnButtonClick = dbgPenawaranItemIDButtonClick
          end
          ...
          object dbgPenawaranColumn10: TdxDBGridColumn
            Caption = 'Product No'
            Width = 84
            BandIndex = 0
            RowIndex = 0
  ...
  inherited quMain: TADOQuery
    ...
    object quMainLcustomer: TStringField
  ...
  inherited quDetil: TADOQuery
    BeforeInsert = quMainBeforeDelete
    BeforeEdit = quMainBeforeDelete
    BeforeDelete = quMainBeforeDelete
  ...
  object quTotal: TADOQuery
    ...
    SQL.Strings = (
        ...
        'LSE (K.SubTotal-K.Disc)+(K.SubTotal-K.Disc)*0.01*K.PPN END as GT' +
        ','
      
        'CASE WHEN K.FgTax='#39'T'#39' THEN 0 ELSE (K.SubTotal-K.Disc)*0.01*K.PPN' +
        ' END as Tax FROM ('
      
        'SELECT ISNULL(SUM(A.Qty*A.Price),0) as SubTotal,B.FgTax,B.GBUID,' +
        'B.Disc,ISNULL(B.PPN,10) as PPN'
