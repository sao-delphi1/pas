inherited fmARRptRekapSODlg: TfmARRptRekapSODlg
  ...
  inherited quAct: TADOQuery
    ...
    SQL.Strings = (
        ...
        'X.SaleID,CONVERT(VARCHAR(10),X.TglInvoice,103) as TglInvoice,Z.G' +
        'BUID,CONVERT(VARCHAR(10),Z.TglPO,103) as TglPO,Z.SuppName,Z.Kons' +
        'inyasiID,'
      
        'CONVERT(VARCHAR(10),Z.TglTerima,103) as TglTerima,Z.PurchaseID,C' +
        'ONVERT(VARCHAR(10),Z.TglBeli,103) as TglBeli,'
      ...
      'LEFT JOIN ('
        ...
        '  SELECT A.SaleID,A.TransDate as TglInvoice,B.ItemID,A.SOID,B.Pr' +
        'ice,A.CustID '
      ...
      'LEFT JOIN ('
        ...
        'e,A.SOID,Y.KonsinyasiID,Y.TglTerima,Y.PurchaseID,Y.TglBeli FROM ' +
        'ARTrPenawaranHd A'
      ...
      '  LEFT JOIN ('
        ...
        'emID,A.POID,X.PurchaseID,X.TransDate as TglBeli FROM APTrKonsiny' +
        'asiHd A'
