inherited fmARRptRekapSODlg: TfmARRptRekapSODlg
  ...
  inherited paCenter: TPanel
    ...
    object dgrReport: TdxDBGrid
        ...
        item
          ...
          SummaryItems = <
            item
              ...
              SummaryField = 'ATotalJual'
              SummaryFormat = '#,0'
              SummaryType = cstSum
            end
            item
              ColumnName = 'dgrReportColumn22'
              SummaryField = 'ATotalModal'
              SummaryFormat = '#,0'
              SummaryType = cstSum
            end
            item
              ColumnName = 'dgrReportColumn23'
              SummaryField = 'ATotalMargin'
              SummaryFormat = '#,0'
              SummaryType = cstSum
            end>
      ...
      object dgrReportColumn21: TdxDBGridColumn
        ...
        BandIndex = 0
        RowIndex = 0
        FieldName = 'ATotalJual'
        SummaryFooterType = cstSum
        SummaryFooterField = 'ATotalJual'
      ...
      object dgrReportColumn22: TdxDBGridColumn
        ...
        BandIndex = 0
        RowIndex = 0
        FieldName = 'ATotalModal'
        SummaryFooterType = cstSum
        SummaryFooterField = 'ATotalModal'
        SummaryFooterFormat = '#,0'
        SummaryType = cstSum
        SummaryField = 'ATotalModal'
        SummaryFormat = '#,0'
      ...
      object dgrReportColumn23: TdxDBGridColumn
        ...
        BandIndex = 0
        RowIndex = 0
        FieldName = 'ATotalMargin'
        SummaryFooterType = cstSum
        SummaryFooterField = 'ATotalMargin'
        SummaryFooterFormat = '#,0'
        SummaryType = cstSum
        SummaryField = 'ATotalMargin'
        SummaryFormat = '#,0'
  ...
  inherited quAct: TADOQuery
    ...
    object quActATotalModal: TCurrencyField
    ...
    object quActATotalJual: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'ATotalJual'
      DisplayFormat = '#,0'
      Currency = False
    ...
    object quActAMargin: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'AMargin'
      DisplayFormat = '#,0'
      Currency = False
    ...
    object quActATotalMargin: TCurrencyField
      FieldKind = fkCalculated
      FieldName = 'ATotalMargin'
      DisplayFormat = '#,0'
      Currency = False
