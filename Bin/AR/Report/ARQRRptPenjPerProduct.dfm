inherited fmARQRRptPenjPerProduct: TfmARQRRptPenjPerProduct
  Left = 297
  Top = 115
  Width = 1418
  Height = 600
  Caption = 'fmARQRRptPenjPerProduct'
  PixelsPerInch = 96
  TextHeight = 13
  inherited MyReport: TQuickRep
    ...
    object GroupFooterBand1: TQRBand
      ...
      object QRLabel12: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'SubTotal Per Produk USD'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
      ...
      object QRLabel11: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'SubTotal Per Produk IDR'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
      ...
      object QRLabel9: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Total Jumlah Barang Per Produk :'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
    ...
    object GroupFooterBand2: TQRBand
      ...
      object QRLabel26: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'SubTotal Per Barang USD'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
      ...
      object QRLabel27: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'SubTotal Per Barang IDR'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
      ...
      object QRLabel32: TQRLabel
        ...
        AutoSize = True
        AutoStretch = False
        Caption = 'Total Jumlah Barang Per Barang :'
        Color = clWhite
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -13
  ...
  inherited qu002: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT distinct C.SaleId,Convert(varchar(10),TransDate,103) as T' +
        'gl,'
      
        'Convert(varchar(8),TransDate,112), A.QTY,B.CustName,C.CurrId,A.P' +
        'rice,(A.Price*A.Qty) as Total '
      
        ' FROM ARTrPenjualanDt A INNER JOIN ARTrPenjualanHd C ON A.SaleId' +
        '=C.SaleId '
  ...
  object qu003: TADOQuery
    ...
    SQL.Strings = (
        ...
        'Convert(varchar(8),TransDate,112), A.QTY,B.CustName,C.CurrId,A.P' +
        'rice,(A.Price*A.Qty) as Total,C.POID '
